...
export class CardDetailsComponent implements OnInit, OnChanges {
    ...
    public titleAndDescription: any = {
        ...
        [this.cardTypes.COMP_DETAILS]: {
            ...
            description: 'A list of all the analyzed dependencies that flags security, usage, and license issues in your stack and suggests alternate dependencies to replace dependencies with these issues.'
        }
    };
